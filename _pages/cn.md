...
代表作 ([完整论文清单](\publications\)):  
------

<span style="color: blue;">我曾在IEEE S&P、USENIX Security、ACM CCS、NDSS等安全顶级会议和TDSC等顶级期刊上发表了40多篇论文。谷歌引用超3000次。 </span>  

<span style="color: blue;">安全顶会 (19 papers): IEEE S&P ('25), USENIX-Security ('24,  '23, '20, '25x3), CCS ('24x3, '23x2, '22x2),  NDSS ('23x3, '25x2)  </span>

<span style="color: blue;">**数据分布:** CCF A: 29 papers, CCF B: 6 papers, CCF C: 5 papers  </span>  
